...
of the [pre-built versions](https://drive.google.com/drive/folders/1pvxQ9evNGOotktH6Kp2p44UAIU5mQw0U?usp=drive_link) (hg38 and mm10 using function defaults), then you 
don't have to worry about Python dependencies since Python is only used during 
index generation.
